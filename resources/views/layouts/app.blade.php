        ...
        <aside id="sidebar" class="w-72 bg-blue-700 text-white flex flex-col shrink-0 h-screen sticky top-0">
            ...
            <div class="sidebar-header p-8 flex items-center justify-between border-b border-blue-600/50">
                <button type="button" id="creator-credit-trigger" class="text-left rounded-xl focus:outline-none focus:ring-2 focus:ring-white/70" aria-label="Logo SIRAT">
                    ...
                    <p class="text-blue-100 mt-2 text-sm sidebar-text">Sistem Reservasi Ruangan FTE</p>
                </button>
            ...
            <nav class="px-4 py-4 flex-1 overflow-y-auto">
                ...
                <a href="/calendar" class="sidebar-nav-link flex items-center gap-3 px-5 py-4 rounded-xl hover:bg-blue-600 mb-3 {{ request()->is('calendar*') ? 'bg-blue-800 font-semibold' : '' }}">
                    <!-- Calendar Grid Icon -->
                    <svg class="w-6 h-6 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="flex items-center gap-5">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div class="hidden sm:block">
                            ...
                            <p class="text-gray-500 text-xs mt-0.5">{{ auth()->user()->role === 'pegawai' ? 'TPA' : 'Dosen' }}</p>
                        </div>
                    </div>
                </div>
            </header>
        ...
        <div class="relative bg-white w-full max-w-4xl max-h-[85vh] rounded-2xl shadow-2xl flex flex-col overflow-hidden border border-slate-200/80 transform scale-95 transition-all duration-300 ease-out z-10">
            ...
            <div class="sticky top-0 bg-slate-50 border-b border-slate-200/80 px-6 py-4 flex items-center justify-between z-20">
                <div class="flex items-center gap-3">
                    ...
                    <h3 class="text-lg font-bold text-slate-800">Buku Panduan Pengguna (Dosen / TPA)</h3>
                </div>
