...
<head>
    ...
    <title>Pengajuan Reservasi Baru – SIRAT Admin</title>
</head>
            ...
            <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff; border-radius:16px; overflow:hidden; box-shadow:0 4px 24px rgba(0,0,0,0.08); max-width:600px; width:100%;">
                ...
                <tr>
                    <td style="background: linear-gradient(135deg, #1e3a8a 0%, #3b82f6 100%); padding: 40px 40px 32px; text-align:center;">
                        ...
                        <p style="color:#93c5fd; margin:0; font-size:14px;">Notifikasi Permintaan Reservasi Baru</p>
                    </td>
                </tr>
                ...
                <tr>
                    <td style="padding: 28px 40px 8px;">
                        ...
                        <p style="margin:10px 0 0; font-size:15px; color:#6b7280; line-height:1.6;">
                            Terdapat pengajuan reservasi ruangan baru dari dosen/staf yang memerlukan perhatian Anda. Berikut adalah rincian pengajuan tersebut:
                        </p>
                    </td>
                </tr>
                    ...
                    <td style="padding: 10px 40px 0;">
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" style="background:#f8fafc; border-radius:12px; border:1px solid #e2e8f0; overflow:hidden; margin-bottom: 20px;">
                            <tr>
                                ...
                                <td style="padding:10px 20px; border-bottom:1px solid #e2e8f0; font-size: 13px; color: #111827; font-weight: 700;">{{ $reservation->user->name }}</td>
                            </tr>
                            <tr>
                                <td style="padding:10px 20px; border-bottom:1px solid #e2e8f0; font-size: 13px; color: #6b7280; font-weight: 600;">Email / NIP</td>
                                <td style="padding:10px 20px; border-bottom:1px solid #e2e8f0; font-size: 13px; color: #111827;">{{ $reservation->user->email }} / {{ $reservation->user->nip ?? '-' }}</td>
                            </tr>
                            @if($reservation->user->phone_number)
                            <tr>
                                <td style="padding:10px 20px; font-size: 13px; color: #6b7280; font-weight: 600;">No. Telepon</td>
                                <td style="padding:10px 20px; font-size: 13px; color: #111827;">{{ $reservation->user->phone_number }}</td>
                            </tr>
                            @endif
                        </table>
                    </td>
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" style="background:#f8fafc; border-radius:12px; border:1px solid #e2e8f0; overflow:hidden;">
                            ...
                            <tr style="border-bottom:1px solid #e2e8f0;">
                                <td style="padding:14px 20px; background:#eff6ff;">
                                    <p style="margin:0; font-size:12px; color:#1e3a8a; font-weight:700; text-transform:uppercase; letter-spacing:0.5px;">Tanggal</p>
                                </td>
                                <td style="padding:14px 20px;">
