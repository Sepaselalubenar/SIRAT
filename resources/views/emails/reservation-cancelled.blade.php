...
<head>
    ...
    <title>Reservasi Dibatalkan oleh Admin – SIRAT</title>
</head>
    ...
    <tr>
        <td align="center">
            ...
            <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff; border-radius:16px; overflow:hidden; box-shadow:0 4px 24px rgba(0,0,0,0.08); max-width:600px; width:100%;">
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0">
                            <tr>
                                <td align="center" style="padding: 24px 0 0 0;">
                                    <span style="display:inline-block; background:#fef3c7; color:#92400e; padding:8px 22px; border-radius:999px; font-size:14px; font-weight:700; letter-spacing:0.3px;">
                ...
                <tr>
                    <td style="padding: 28px 40px 8px;">
                        ...
                        <p style="margin:10px 0 0; font-size:15px; color:#6b7280; line-height:1.6;">
                            Kami informasikan bahwa reservasi ruangan Anda telah <strong style="color:#92400e;">dibatalkan oleh Admin</strong>. Berikut adalah rincian reservasi yang dibatalkan:
                        </p>
                    </td>
                </tr>
                    ...
                    <td style="padding: 20px 40px 0;">
                        <table width="100%" cellpadding="0" cellspacing="0" style="background:#f8fafc; border-radius:12px; border:1px solid #e2e8f0; overflow:hidden;">
                            ...
                            <tr>
                                ...
                                <td style="padding:14px 20px;">
                                    <span style="display:inline-block; background:#fef3c7; color:#92400e; padding:4px 12px; border-radius:999px; font-size:13px; font-weight:700;">Dibatalkan</span>
                                </td>
                            </tr>
                ...
                <tr>
                    <td style="padding: 20px 40px 0;">
                        <table width="100%" cellpadding="0" cellspacing="0" style="background:#fffbeb; border-radius:10px; border:1px solid #fcd34d;">
                            <tr>
                                <td style="padding:14px 18px;">
                                    <p style="margin:0; font-size:13px; color:#92400e; font-weight:700; text-transform:uppercase; letter-spacing:0.5px;">Alasan Pembatalan oleh Admin:</p>
                ...
                <tr>
                    <td style="padding: 20px 40px 0;">
                        <p style="margin:0; font-size:14px; color:#6b7280; line-height:1.7;">
                            Jika Anda memiliki pertanyaan mengenai pembatalan ini, silakan hubungi Admin secara langsung.
                            Anda dapat mengajukan reservasi baru melalui sistem jika masih diperlukan.
                        </p>
                    </td>
                </tr>
