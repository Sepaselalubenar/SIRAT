...
@section('title', 'Kalender Ketersediaan Ruangan')
...
<div class="space-y-6">
    ...
    <!-- Page Header -->
    <div>
        <h1 class="text-2xl lg:text-3xl font-bold text-gray-800">Kalender Ketersediaan Ruangan</h1>
        <p class="text-gray-500 mt-1 text-sm">Lihat jadwal pemakaian setiap ruangan per hari di sini.</p>
    </div>
    ...
    <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-5">
        <div class="flex flex-col sm:flex-row gap-4 items-start sm:items-end">
            ...
            <div class="flex items-center gap-2 shrink-0">
                <button id="prev-day" class="p-3 rounded-xl border border-gray-200 hover:bg-gray-50 transition text-gray-600 cursor-pointer" title="Hari sebelumnya">
                ...
                <button id="next-day" class="p-3 rounded-xl border border-gray-200 hover:bg-gray-50 transition text-gray-600 cursor-pointer" title="Hari berikutnya">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <!-- Current Date Display & View Switcher -->
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div class="flex bg-gray-100 p-1 rounded-xl self-start sm:self-auto shadow-inner border border-gray-200">
            <button id="view-timeline-btn" class="px-3.5 py-1.5 rounded-lg text-xs font-semibold flex items-center gap-1.5 transition cursor-pointer">
                <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M3 10h18M3 14h18m-9-4v8m-9-8v8m18-8v8" />
                </svg>
                Timeline
            </button>
            <button id="view-list-btn" class="px-3.5 py-1.5 rounded-lg text-xs font-semibold flex items-center gap-1.5 transition cursor-pointer">
                <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
